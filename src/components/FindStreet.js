...
const FindStreet = ({ navigation, route }) => {
  ...
  const { street, neighborhoodValue } = route.params;

  const getApartment = async (value) => {
    try {
      setIndicator(true);
      ...
      setIndicator(false);
      if (status === true) {
        navigation.navigate("Find Apartment", {
          apartment: data,
    ...
    <KeyboardAvoidingView style={styles.container} behavior="position">
      ...
      <View style={styles.dropdownView}>
        <DropDownPicker
          ...
          searchable
          placeholder={"Cadde/Sokak seçiniz"} // Değişecek
